...
docker run -d --rm --privileged --network host --env="DISPLAY=$DISPLAY" --env="QT_X11_NO_MITSHM=1" --volume=/tmp/.X11-unix:/tmp/.X11-unix:rw -v /run/udev:/run/udev vision_raspberry_pi
