...
def draw_overlay(frame,
    ...
    try:
        ...
        #                 text=str(telemetry_data[2]),
        #                 org=(420, 40),
        #                 fontFace=cv2.FONT_HERSHEY_SIMPLEX,
        #                 fontScale=0.7, color=(255, 255, 255),
        #                 thickness=1) #Motorstellwerte  
        #     cv2.putText(img=frame,
        #                 text=str(telemetry_data[3]),
        #                 org=(520, 40),
        #                 fontFace=cv2.FONT_HERSHEY_SIMPLEX,
        #                 fontScale=0.7,
        #                 color=(255, 255, 255),
        ...
        # 
        #     cv2.putText(img=frame,
        #                 text="Akku:   "+str(telemetry_data[6]),
        #                 org=(20, 40),
        #                 fontFace=cv2.FONT_HERSHEY_SIMPLEX,
        #                 fontScale=0.7,
        #                 color=(255,255,255),
        #                 thickness=1)
        #     cv2.putText(img=frame,
        #                 text="DC24V: "+str(telemetry_data[7]),
        #                 org=(20, 65),
        #                 fontFace=cv2.FONT_HERSHEY_SIMPLEX,
        #                 fontScale=0.7,
        #                 color=(255,255,255),
        #                 thickness=1)
        #     cv2.putText(img=frame,
        #                 text="Logik:   "+str(telemetry_data[8]),
        #                 org=(20, 90),
        #                 fontFace=cv2.FONT_HERSHEY_SIMPLEX,
        #                 fontScale=0.7,
        #                 color=(255,255,255),
        ...
        #             cv2.putText(img=frame,
        #                         text="Suche Marker "+str(navigation_list[actual_ID]),
        #                         org=(350, 290),
        #                         fontFace=cv2.FONT_HERSHEY_SIMPLEX,
        #                         fontScale=0.9,
        #                         color=(0, 0, 255),
